...
! routine to put electrons down electrons in approximately a uniform
! mesh if nothing else is available.  Do not make random part eps too
! small otherwise in parallel mode configurations on different processors
...
!     write(6,'(''rlatt_sim'',3(3f9.4))') rlatt_sim
! do up-spin electrons
...
!     write(6,'(''nlin1,nlin2,nlin3=''3i4)') nlin1,nlin2,nlin3
...
! Check that there are no close ones.
      do 60 i=2,nelec
        do 60 j=1,i-1
          dist=0
          do 50 k=1,ndim
