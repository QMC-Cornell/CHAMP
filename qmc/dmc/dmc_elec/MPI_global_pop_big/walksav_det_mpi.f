...
# if  defined (MPI)
      ...
      do 150 k=1,ndet
        ...
        call MPI_Wait(irequest,istatus,ierr)
        call mpi_isend(slmdiw(1,k,nwalk),ndn*ndn,mpi_double_precision,irecv,itag+3,MPI_COMM_WORLD,irequest,ierr)
        call MPI_Wait(irequest,istatus,ierr)
        call mpi_isend(fpdw(1,1,k,nwalk),3*ndn*ndn,mpi_double_precision,irecv,itag+4,MPI_COMM_WORLD,irequest,ierr)
        call MPI_Wait(irequest,istatus,ierr)
        call mpi_isend(ddeti_detiw(1,1,k,nwalk),3*nelec,mpi_double_precision,irecv,itag+5,MPI_COMM_WORLD,irequest,ierr)
        call MPI_Wait(irequest,istatus,ierr)
  150   itag=itag+5
      return
      ...
      do 160 k=1,ndet
        ...
        call mpi_recv(slmdiw(1,k,nwalk),ndn*ndn,mpi_double_precision,isend,itag+3,MPI_COMM_WORLD,istatus,ierr)
        call mpi_recv(fpdw(1,1,k,nwalk),3*ndn*ndn,mpi_double_precision,isend,itag+4,MPI_COMM_WORLD,istatus,ierr)
        call mpi_recv(ddeti_detiw(1,1,k,nwalk),3*nelec,mpi_double_precision,isend,itag+5,MPI_COMM_WORLD,istatus,ierr)
  160   itag=itag+5
