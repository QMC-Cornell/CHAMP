      subroutine dumper_dmc_mov1_mpi1
...
! Warning need to change to allocate
      dimension irand_seed_loc(4,0:nproc)
    ...
    4   if(nloc.gt.0) &
     &  read(10) nquad,(xq(i),yq(i),zq(i),wq(i),i=1,nquad)
      do 5 id=idtask+1,nproc-1
        read(10) nwalk_id
        read(10) (xoldw_id,i=1,ndim*nelec*nwalk_id)
...
!       read(10) (wgcum_id,egcum_id,pecum_id,tpbcum_id,tjfcum_id,
!    &  wgcm2_id,egcm2_id,pecm2_id,tpbcm2_id,tjfcm2_id,taucum_id,
!    &  i=1,nforce)
    5   if(nloc.gt.0) &
