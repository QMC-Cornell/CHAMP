...
! /config_dmc/ included to print out xold and vold for old walkers
...
!     eval_eff=nconf_global*rn_eff(wcum1,wcm21)
!     evalf_eff=nconf_global*rn_eff(wfcum1,wfcm21)
!     evalg_eff=nconf_global*rn_eff(wgcum1(1),wgcm21(1))
...
!     write(6,'(''eacc,enacc='',2f12.6,2i9)') eacc/macc,enacc/mnacc,acc_int,mnacc
!     write(6,'(9d20.12)') wcum,wcum1,wfcum,wfcum1,wgcum,wgcum1
