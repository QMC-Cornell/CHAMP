...
#
print MAKEFILE "SRCS =\t";
@srcs = <*.f90 commons/*.f90 MED_tools/*.f90 tools/*.f tools/*.f90 tools/*.c initialization/*.f90 fit/*.f90 vmc/*.f90 dmc/*.f90 dmc/dmc_elec/*.f90>;
push(@srcs,<fit/MPI/*.f fit/MPI/*.f90 vmc/MPI/*.f90 dmc/dmc_elec/MPI/*.f90 dmc/dmc_elec/MPI_global_pop/*.f90 dmc/dmc_elec/MPI_global_pop_big/*.f90>);
&PrintWords(8, 0, @srcs);
print MAKEFILE "\n\n";
#
# Object listing
...
#
print MAKEFILE "dir:\n";
print MAKEFILE "\tbash ../tools/mk_fortran_dir\n\n";
#
# revision_and_date
#
...
print MAKEFILE "\trm -fr *.dif *.lst *.sav fortran_modules fortran_objects\n";
print MAKEFILE "\n";
...
# (BM: automate that?)
#
print MAKEFILE "\$(OBJDIR)/%.o:%.f90\n";
print MAKEFILE "\t\$(F95) \$(F95_FLAGS) \$(INCCMD)\$(INCDIR) \$(MODCMD)\$(MODDIR) -o \$@ -c \$<\n";
print MAKEFILE "\$(OBJDIR)/%.o:commons/%.f90\n";
print MAKEFILE "\t\$(F95) \$(F95_FLAGS) \$(INCCMD)\$(INCDIR) \$(MODCMD)\$(MODDIR) -o \$@ -c \$<\n";
print MAKEFILE "\$(OBJDIR)/%.o:MED_tools/%.f90\n";
print MAKEFILE "\t\$(F95) \$(F95_FLAGS) \$(INCCMD)\$(INCDIR) \$(MODCMD)\$(MODDIR) -o \$@ -c \$<\n";
print MAKEFILE "\$(OBJDIR)/%.o:initialization/%.f90\n";
print MAKEFILE "\t\$(F95) \$(F95_FLAGS) \$(INCCMD)\$(INCDIR) \$(MODCMD)\$(MODDIR) -o \$@ -c \$<\n";
print MAKEFILE "\$(OBJDIR)/tools/%.o:tools/%.f\n";
print MAKEFILE "\t\$(F77) \$(F77_FLAGS) \$(INCCMD)\$(INCDIR) \$(MODCMD)\$(MODDIR) -o \$@ -c \$<\n";
print MAKEFILE "\$(OBJDIR)/%.o:tools/%.f90\n";
print MAKEFILE "\t\$(F95) \$(F95_FLAGS) \$(INCCMD)\$(INCDIR) \$(MODCMD)\$(MODDIR) -o \$@ -c \$<\n";
print MAKEFILE "\$(OBJDIR)/tools/address_tools.o:tools/address_tools.c\n";
print MAKEFILE "\t\$(CC) \$(CC_FLAGS) \$(INCCMD)\$(INCDIR) \$(MODCMD)\$(MODDIR) -o \$@ -c \$<\n";
print MAKEFILE "\$(OBJDIR)/%.o:fit/%.f90\n";
print MAKEFILE "\t\$(F95) \$(F95_FLAGS) \$(INCCMD)\$(INCDIR) \$(MODCMD)\$(MODDIR) -o \$@ -c \$<\n";
print MAKEFILE "\$(OBJDIR)/%.o:fit/MPI/%.f90\n";
print MAKEFILE "\t\$(F95) \$(F95_FLAGS) \$(INCCMD)\$(INCDIR) \$(MODCMD)\$(MODDIR) -o \$@ -c \$<\n";
print MAKEFILE "\$(OBJDIR)/%.o:vmc/%.f90\n";
print MAKEFILE "\t\$(F95) \$(F95_FLAGS) \$(INCCMD)\$(INCDIR) \$(MODCMD)\$(MODDIR) -o \$@ -c \$<\n";
print MAKEFILE "\$(OBJDIR)/%.o:vmc/MPI/%*.f90\n";
print MAKEFILE "\t\$(F95) \$(F95_FLAGS) \$(INCCMD)\$(INCDIR) \$(MODCMD)\$(MODDIR) -o \$@ -c \$<\n";
print MAKEFILE "\$(OBJDIR)/%.o:dmc/%*.f90\n";
print MAKEFILE "\t\$(F95) \$(F95_FLAGS) \$(INCCMD)\$(INCDIR) \$(MODCMD)\$(MODDIR) -o \$@ -c \$<\n";
print MAKEFILE "\$(OBJDIR)/%.o:dmc/dmc_elec/%*.f90\n";
print MAKEFILE "\t\$(F95) \$(F95_FLAGS) \$(INCCMD)\$(INCDIR) \$(MODCMD)\$(MODDIR) -o \$@ -c \$<\n";
print MAKEFILE "\$(OBJDIR)/%.o:dmc/dmc_elec/MPI/%*.f90\n";
print MAKEFILE "\t\$(F95) \$(F95_FLAGS) \$(INCCMD)\$(INCDIR) \$(MODCMD)\$(MODDIR) -o \$@ -c \$<\n";
print MAKEFILE "\$(OBJDIR)/%.o:dmc/dmc_elec/MPI_global_pop/%*.f90\n";
print MAKEFILE "\t\$(F95) \$(F95_FLAGS) \$(INCCMD)\$(INCDIR) \$(MODCMD)\$(MODDIR) -o \$@ -c \$<\n";
print MAKEFILE "\$(OBJDIR)/%.o:dmc/dmc_elec/MPI_global_pop_big/%*.f90\n";
print MAKEFILE "\t\$(F95) \$(F95_FLAGS) \$(INCCMD)\$(INCDIR) \$(MODCMD)\$(MODDIR) -o \$@ -c \$<\n";
print MAKEFILE "\n\n";
#
# Dependency listings
