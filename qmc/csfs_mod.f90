...
! loop over menu lines
  ...
  case ('help')
   ...
   write(6,'(a)') '  rotation_parameters = [logical] : optimize CSF rotation parameters (rather than linear parameters) (default=false)'
   write(6,'(a)') ' end'
   write(6,*)
  ...
  case ('rotation_parameters')
   ...
   if(l_opt_csf_rot) then
     !MJO ADD LOOP
      ...
      !
      ! exp(R)|0> = cos(d)|0> + sin(d)/d sum R_k |k>
