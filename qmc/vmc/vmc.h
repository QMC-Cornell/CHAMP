...
!       parameter(MCTYPE=2, MCENT=MAX(4,MCTYPE), MELECUD=35, MELEC=MAX(70,MELECUD))
!       parameter(MORB_OCC=42, MORB=MAX(80,MORB_OCC), MBASIS_CTYPE=44, MBASIS=(100,MBASIS_CTYPE))
!      parameter(MCSF=165, MDET_CSF=140, MDETUD=190, MDET=MAX(660,MDET_CSF,MDETUD))
!      parameter(MCSF=60, MDET_CSF=132, MDETUD=162, MDET=MAX(350,MDET_CSF,MDETUD))
!      parameter(MCSF=20, MDET_CSF=32, MDETUD=10, MDET=MAX(50,MDET_CSF,MDETUD))
!       parameter(MCSF=10, MDET_CSF=10, MDETUD=5, MDET=MAX(10,MDET_CSF,MDETUD))
!       parameter(MOTYPE=5, MPARMD=MAX(100,MCSF), ML_BAS=4)

! Julien:
      parameter(MCTYPE=2, MCENT=MAX(10,MCTYPE), MELECUD=9, MELEC=MAX(18,MELECUD))
      parameter(MORB_OCC=10, MORB=MAX(68,MORB_OCC), MBASIS_CTYPE=66, MBASIS=(68,MBASIS_CTYPE))
