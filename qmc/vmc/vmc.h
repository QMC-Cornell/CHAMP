...
!JT      parameter(DBLMIN=1.d-300,DBLMAX=1.d+300)
      ...
      parameter(MCENT=2,MCTYPE=2,MELEC=20,MELECUD=20,MORB=100,MORB_OCC=18)
      parameter(MBASIS=100,MBASIS_CTYPE=50)
      parameter(MDET=260,MDETUD=30,MCSF=65,MDET_CSF=20)
