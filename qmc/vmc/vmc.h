...
! Julien:
!     parameter(MCENT=3,MCTYPE=2,MELEC=17,MELECUD=9,MORB=66,MORB_OCC=10)
!     parameter(MBASIS=66,MBASIS_CTYPE=66)
!     parameter(MDET=30,MDETUD=30,MCSF=20,MDET_CSF=10)
!     parameter(MOTYPE=5,MPARMD=170)
!     parameter(NSPLIN=1001,MORDJ=7,MPARMJ=70,ML_BAS=4,NRAD=1001,RADMAX=8.d0)

! Cyrus:
      parameter(MCENT=8,MCTYPE=2,MELEC=42,MELECUD=40,MORB=64,MORB_OCC=24)
      parameter(MBASIS=272,MBASIS_CTYPE=102)
!     parameter(MDET=660,MDETUD=190,MCSF=165,MDET_CSF=140)
      parameter(MDET=100,MDETUD=20,MCSF=16,MDET_CSF=10)
...
! Wissam:
!     parameter(MCENT=17,MCTYPE=4,MELEC=70,MELECUD=40,MORB=50,MORB_OCC=34)
!     parameter(MBASIS=62,MBASIS_CTYPE=50)
!     parameter(MDET=2,MDETUD=2,MCSF=2,MDET_CSF=2)
!     parameter(MOTYPE=5,MPARMD=100)
!     parameter(NSPLIN=1001,MORDJ=7,MPARMJ=70,ML_BAS=4,NRAD=1001,RADMAX=8.d0)
