...
!     &,MORB_OCC=24, MORB=MAX(64,MORB_OCC), MBASIS_CTYPE=102, MBASIS=(272,MBASIS_CTYPE)
!!    &,MCSF=165, MDET_CSF=140, MDETUD=190, MDET=MAX(660,MDET_CSF,MDETUD)
!     &,MCSF=16, MDET_CSF=10, MDETUD=20, MDET=MAX(100,MDET_CSF,MDETUD)
!     &,MOTYPE=5, MPARMD=MAX(770,MCSF), ML_BAS=4)
...
! Julien:
      parameter(MCTYPE=2, MCENT=MAX(8,MCTYPE), MELECUD=9, MELEC=MAX(17,MELECUD))
      parameter(MORB_OCC=10, MORB=MAX(66,MORB_OCC), MBASIS_CTYPE=66, MBASIS=(66,MBASIS_CTYPE))
      parameter(MCSF=20, MDET_CSF=10, MDETUD=30, MDET=MAX(30,MDET_CSF,MDETUD))
      parameter(MOTYPE=5, MPARMD=MAX(170,MCSF), ML_BAS=4)

! Ryo, Masayoshi:
!     parameter(MCTYPE=1, MCENT=MAX(1,MCTYPE), MELECUD=90, MELEC=MAX(180,MELECUD)
!    &,MORB_OCC=90, MORB=MAX(90,MORB_OCC), MBASIS_CTYPE=180, MBASIS=(180,MBASIS_CTYPE)
!    &,MCSF=30, MDET_CSF=20, MDETUD=10, MDET=MAX(100,MDET_CSF,MDETUD)
!    &,MOTYPE=5, MPARMD=MAX(170,MCSF), ML_BAS=6)

! Wissam:
!     parameter(MCTYPE=4, MCENT=MAX(17,MCTYPE), MELECUD=40, MELEC=MAX(70,MELECUD)
!    &,MORB_OCC=34, MORB=MAX(50,MORB_OCC), MBASIS_CTYPE=50, MBASIS=(62,MBASIS_CTYPE)
!    &,MCSF=2, MDET_CSF=2, MDETUD=30, MDET=MAX(2,MDET_CSF,MDETUD)
!    &,MOTYPE=5, MPARMD=MAX(170,MCSF), ML_BAS=4)
! Devrim:
!      parameter(MCENT=3,MCTYPE=2,MELEC=31,MELECUD=31,MORB=50,MORB_OCC=50)
!      parameter(MBASIS=50,MBASIS_CTYPE=50)
!      parameter(MDET=30,MDETUD=30,MCSF=20,MDET_CSF=10)
!      parameter(MOTYPE=5,MPARMD=270)
!      parameter(NSPLIN=1001,MORDJ=7,MPARMJ=70,ML_BAS=30,NRAD=1001,RADMAX=28.d0)
